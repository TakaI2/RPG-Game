...
**更新日時**: 2026-03-08（本日更新）
**現在のフェーズ**: Phase 3 仕上げ → 残タスク実装フェーズ
...
- ⏳ 残タスク: 4件（アセット統合・特殊攻撃・bad1.json接続等）
...
gantt
    ...
    BGMバグ修正テスト実施           :active, phase3h, 2026-03-08, 2026-03-08
    ストーリー/エンディング改修     :phase3i, 2026-03-09, 2026-03-12
    新キャラアセット統合            :phase3j, 2026-03-09, 2026-03-12
    player/enemy/editor/map改修     :phase3k, 2026-03-12, 2026-03-14
    section Phase 4 完成
    最終テスト・リリース            :phase4, 2026-03-14, 2026-03-17
```
...
2. **[🔴 高] bad1.json をゲームに接続** — BAD ENDスクリプトが作成済みだがgameflow.jsonに未接続
3. **[🔴 高] 新キャラアセット統合** — `ArisaPlus.png` / `Girl_plus.png` をゲームに組み込む
4. **[🟡 中] 敵ひんし状態の実装** — HP10以下でひんしアニメ連続再生（`enemy改修案.txt` の残タスク）
5. **[🟡 中] mapエディタへのNPC/ポータル配置機能追加** — `editor改修案.txt` の残タスク
6. **[🟡 中] player特殊攻撃の実装** — ファイヤーボール（`player改修案2_18.txt`）
7. **[🟢 低] feature/title-screen-and-pause-menu を main にマージ** — 現ブランチの安定化後
